...
/**
 * Class responsible for send an exception to google analytics
 * Created by everton on 07/10/15.
 */
public class AnalyticsException {

    public static void sendExceptionInformation(Context context, Exception e) {
        Tracker t = PassShelterApp.tracker;
