 ...
 */
public class LocalUserRepTest extends AndroidTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        localUserRep = new LocalUserRep(context, encryption);
    }
    ...
    public void testUser() throws InvalidKeyException, BadPaddingException,
        ...
        localUserRep.saveUser(user);
        assertEquals(user, localUserRep.getUser());
    }

    public void testPassword() throws NoSuchAlgorithmException {
        String pwd = "abcxyz123";
        localUserRep.savePassword(pwd);
        assertTrue(localUserRep.validatePassword(pwd));
    }
}